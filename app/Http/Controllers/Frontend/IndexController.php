...
class IndexController extends Controller
{
    ...
    {
        $footer_menu = FooterMenu::where ('id',$id)->get();
        return view('frontend.footer_details.footer_details', compact('footer_menu'));
    } // End Method
    
     public function Campaign($id)
    {
        $campaigns = Product::where ('campaign',$id)->get();
        return view('frontend.product.campaign_view', compact('campaigns'));
    } // End Method
