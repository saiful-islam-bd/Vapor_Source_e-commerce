        ...
        @endif
            ...
            <li>
                <a href="javascript:;" class="has-arrow">
                    ...
                    <div class="menu-title">Footer Slider Manage</div>
                </a>
                <ul>
                    @if (Auth::user()->can('slider.list'))
                        <li> <a href="{{ route('footer.slider') }}"><i class="bx bx-right-arrow-alt"></i>All Slider</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('slider.add'))
                        <li> <a href="{{ route('footer.add.slider') }}"><i class="bx bx-right-arrow-alt"></i>Add Slider</a>
                        </li>
                    @endif
        ...
        @if (Auth::user()->can('ads.menu'))
            ...
            <li>
                <a href="javascript:;" class="has-arrow">
                    ...
                    <div class="menu-title">Footer Menu Manage</div>
                </a>
                <ul>
                    @if (Auth::user()->can('ads.list'))
                        <li> <a href="{{ route('all.footer_menu') }}"><i class="bx bx-right-arrow-alt"></i>All Footer
                                Menu</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('ads.add'))
                        <li> <a href="{{ route('add.footer_menu') }}"><i class="bx bx-right-arrow-alt"></i>Add Footer
                                Menu</a>
                        </li>
                    @endif
                </ul>
