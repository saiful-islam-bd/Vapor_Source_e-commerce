                            ...
                            <div class="col-lg-4">
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="form-group col-12">
                                            <label for="inputProductType" class="form-label">Add To Campaign</label>
                                            <select name="campaign" class="form-select" id="inputProductType">
                                                <option></option>
                                                @foreach ($campaigns as $campaign)
                                                    <option value="{{ $campaign->id }}">{{ $campaign->banner_title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
