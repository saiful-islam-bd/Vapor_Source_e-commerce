...
use App\Http\Controllers\Backend\FooterSliderController;
...
Route::get('footerDetails/{id}', [IndexController::class, 'Details'])->name('details');
Route::get('campaign/{id}', [IndexController::class, 'Campaign'])->name('campaign');
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Footer Slider All Route
    Route::controller(FooterSliderController::class)->group(function () {
        Route::get('/all/footerslider', 'AllSlider')->name('footer.slider');
        Route::get('/add/footerslider', 'AddSlider')->name('footer.add.slider');
        Route::post('/store/footerslider', 'StoreSlider')->name('footer.store.slider');
        Route::get('/edit/footerslider/{id}', 'EditSlider')->name('footer.edit.slider');
        Route::post('/update/slider', 'UpdateSlider')->name('footer.update.slider');
        Route::get('/delete/slider/{id}', 'DeleteSlider')->name('footer.delete.slider');
    });
    ...
    // Footer Menu All Route
    Route::controller(FooterController::class)->group(function () {
        Route::get('/all/footer_menu', 'AllFooterMenu')->name('all.footer_menu');
        Route::get('/add/footer_menu', 'AddFooterMenu')->name('add.footer_menu');
        Route::post('/store/footer_menu', 'StoreFooterMenu')->name('store.footer_menu');
        Route::get('/edit/footer_menu/{id}', 'EditFooterMenu')->name('edit.footer_menu');
        Route::post('/update/footer_menu', 'UpdateFooterMenu')->name('update.footer_menu');
        Route::get('/delete/footer_menu/{id}', 'DeleteFooterMenu')->name('delete.footer_menu');
    });
